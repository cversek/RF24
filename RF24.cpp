...
SPISettings RF24_spi_settings(4000000, MSBFIRST, SPI_MODE0);
#endif
...
void RF24::csn(bool mode)
{
  ...
  // CLK:BUS 8Mhz:2Mhz, 16Mhz:4Mhz, or 20Mhz:5Mhz
    ...
    //do not alter default bus settings
  #elif  ( !defined(RF24_TINY) && !defined (__arm__)  && !defined (SOFTSPI)) || defined (CORE_TEENSY)
    _SPI.setBitOrder(MSBFIRST);
    _SPI.setDataMode(SPI_MODE0);
    _SPI.setClockDivider(24);//SPI_CLOCK_DIV24);
  #endif
#endif
...
#else
  #if defined (SPI_HAS_TRANSACTION)
  SPI.beginTransaction(RF24_spi_settings);
  #endif
  csn(LOW);
